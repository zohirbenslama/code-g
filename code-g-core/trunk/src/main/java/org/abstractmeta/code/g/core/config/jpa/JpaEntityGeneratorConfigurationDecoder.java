...
//            result.setEntityPostfix(descriptor.getTargetClassPostfix());
//            result.setEntityPrefix(descriptor.getTargetClassPrefix());
...
//            }
//            result.setTypeMapping(DecoderUtil.readPrefixedIntegerToClassMap(options, "typeMapping"));
//            if (isSql) {
//                result.setSqlName(DecoderUtil.readStringRequired(options, "sqlName"));
//            }
//
//        } catch (RuntimeException e) {
//            throw new IllegalStateException("Failed to load JPA configuration for descriptor " + descriptor.getCodeGenerator(), e);
//        }
//        return result;
//    }
//
