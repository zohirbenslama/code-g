...
/**
 * Represents method match for the java method and given method pattern.
 ...
 * The following method pattern: <br/>
 ...
 * <li>Foo getFoo(String name)</li>
 * <li>boolean isFoo(String name)</li>
 * Although method Collection&lt;Foo> getFoo() could be matched by name, pattern also specifies baseParameterTypes as one any type argument,
