...
/**
 * This handle creates a proxy to a set method.
 *
 * @author Adrian Witas
 */
public class SupperSetterFieldHandler {
//
//    private final JavaTypeBuilderImpl ownerTypeBuilder;
//    private final Descriptor descriptor;
//
//    public SupperSetterFieldHandler(JavaTypeBuilderImpl ownerTypeBuilder, Descriptor descriptor) {
...
//                methodBuilder.addBodyLines(generateBody(methodName, fieldName));
...
//   }
//
//    protected Collection<String> generateBody(String methodName, String argumentFieldName) {
//        return Arrays.asList(String.format("super.%s(%s);", methodName, argumentFieldName));
//    }
//
