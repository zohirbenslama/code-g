...
public class ClassGeneratorPlugin extends AbstractGeneratorPlugin implements CodeGeneratorPlugin {
    ...
    public ClassGeneratorPlugin() {
        this(new MethodMatcherImpl());
    }

    protected ClassGeneratorPlugin(MethodMatcher methodMatcher) {
        super(Arrays.asList(new AccessorFieldExtractor(), new RegistryFieldExtractor()), Collections.<MethodExtractor>emptyList());
